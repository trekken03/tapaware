...
const AdminDashboard = () => {
    ...
    const statCards = [
        ...
        { label: 'Average TDS (ppm)', value: summary?.average_tds || 0, icon: Droplets, color: 'text-purple-600', bg: 'bg-purple-50', path: '/visualization' },
    ]
                                    ...
                                    {tdsByPurok.map((item) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`text-lg font-bold ${tdsColors(
                                                        parseFloat(item.average_tds)
                                                    )}`}
                                                >
                                                    {parseFloat(item.average_tds).toFixed(2)}
                                                </span>
