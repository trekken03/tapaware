                                ...
                                {filteredHouseholds.map((h) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`flex gap-4 rounded-2xl border-t-4 border ${status.border} p-4 shadow-lg h-full cursor-pointer hover:shadow-md transition-all duration-200 hover:-translate-y-2`}>
