...
router.get('/summary', verifyToken, requireRole('admin', 'staff'), analyticsController.getSummary);
...
router.get('/tds-by-purok', verifyToken, requireRole('admin', 'staff'), analyticsController.getTdsByPurok);
